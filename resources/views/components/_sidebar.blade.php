<aside name="sidebar" class="hidden md:flex sm:fixed flex z-20 top-0 fixed h-full w-8 sm:w-20 flex-col space-y-14 items-center justify-center bg-background text-icons">
    ...
    <!-- Configuration -->
    @auth
    <a href="/profile/{{ auth()->user()->username }}" class="h-6 w-6 sm:h-10 sm:w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white ">
        <svg
          width="32"
          height="32"
          viewBox="0 0 24 24"
    ...
    @guest
    <a href="/login" class="h-6 w-6 sm:h-10 sm:w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white ">
        <svg
          width="32"
          height="32"
          viewBox="0 0 24 24"
...
<!-- FOOTER ALS HET SCHERM TE KLEIN IS -->
...
<aside class="block md:hidden fixed bottom-0 z-20 w-full flex justify-around items-center bg-background text-icons py-2">
    ...
    <button data-twe-toggle="modal" data-twe-target="#createPostModal" class="h-10 w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
    ...
    <!-- Configuration -->
    @auth
    <a href="/profile/{{ auth()->user()->username }}" class="h-10 w-10 sm:h-10 sm:w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
        <svg
          width="32"
          height="32"
          viewBox="0 0 24 24"
    ...
    @guest
    <a href="/login" class="h-10 w-10 sm:h-10 sm:w-10 flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
        <svg
          width="32"
          height="32"
          viewBox="0 0 24 24"
