        ...
        <div class="flex items-center mb-1" >
            ...
            <div>
                <div class="flex">
                    ...
                    <p class="font-bold pl-2 text-md text-placeholder">and {{ $post->likedBy->count() - 1 }} others</p>
                    @else
                    <a href="/profile/{{$mostRecentLike->username}}" class="font-bold text-md text-white hover:underline">
                    {{ $mostRecentLike->username }}
                    </a>
                    <p class="font-bold pl-2 text-md text-placeholder">liked your post</p>
                    @endif
