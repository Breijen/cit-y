...
<div class="pb-4 p-2">
    ...
    <div class="flex pb-4 cursor-pointer" onclick="location.href='/{{$quote->postUser['username']}}/{{$quote->post['uuid']}}'">
        ...
        <div class="flex items-center mb-1" >
            <div class="pl-1">
                ...
                <div>
                    <p class="text-gray-300 text-sm mt-1">{{$quote->post["content"]}}</p>
                </div>
            </div>
        </div>
    </div>
