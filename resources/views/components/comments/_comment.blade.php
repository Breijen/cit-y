<div class="mt-2 p-2">
    <div class="mb-4 cursor-pointer" onclick="location.href='/{{$comment->post['username']}}/{{$comment->post['uuid']}}';">
    ...
    @auth  
    <div class="flex mt-4 mb-4 items-center text-gray-300 space-x-6">
