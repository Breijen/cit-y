        ...
        @method('PUT')
            <div class="flex items-center mb-4 p-4">
                    ...
                    <div>
                        ...
                        <input name="content" id="postEditInput" type="text" class="w-full bg-content_bg text-white rounded-lg focus:outline-none">
                    </div>
            </div>
...
<script type="text/javascript">
    ...
    const doneButton = document.getElementById('editButton');
