...
@auth    
    <div class="flex pb-6 text-gray-300 space-x-6">
        ...
        <div class="flex items-center space-x-2">
            <svg onclick="quotePost('{{$post->username}}', '{{$post->uuid}}')" width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 cursor-pointer">
