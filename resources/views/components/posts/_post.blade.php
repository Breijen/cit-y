...
<script>
    ...
    function votePoll(optionId) {
        event.stopPropagation();
        console.log('Voting for option:', optionId); // Debugging line

        try {
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = `/poll-options/${optionId}/vote`;
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        console.log('Document loaded and script initialized'); // Debugging line
    });
</script>
