<div class="pb-4 p-2">
    <div class="pb-2 cursor-pointer" onclick="location.href='/{{$post['username']}}/{{$post['uuid']}}'">
...
@auth    
    <div class="flex text-gray-300 space-x-6">
