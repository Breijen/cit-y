<div class="space-y-4 w-full max-w-4xl mx-auto p-4 bg-content_bg  mb-4 relative">
    ...
    <form method="post" action="/posts" enctype="multipart/form-data" class="-pt-8">
        ...
        <div id="pollSection" class="hidden">
            <div id="pollOptions">
                <input type="text" name="options[]" class="p-2 w-full bg-content_bg border border-divider text-white placeholder-placeholder pl-2 rounded-lg focus:outline-none grow mb-2" placeholder="Yes" required>
                <input type="text" name="options[]" class="p-2 w-full bg-content_bg border border-divider text-white placeholder-placeholder pl-2 rounded-lg focus:outline-none grow mb-2" placeholder="No" required>
            </div>
        ...
        <div class="flex space-x-2 ml-2">
            ...
            <label for="pollToggle" class="cursor-pointer">
                <input type="checkbox" id="pollToggle" name="pollToggle" class="focus:outline-none hidden" onchange="togglePollSection()">
