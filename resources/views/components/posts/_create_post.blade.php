<div class="space-y-4 w-fulll max-w-4xl mx-auto p-4 bg-content_bg rounded-lg border border-divider mb-4">
    ...
    <form method="post" action="/posts" enctype="multipart/form-data">
        @csrf
        <div class="mb-2">
            <input name="content" id="postInput" autocomplete="off" type="text" placeholder="What are you thinking about?" class="w-full bg-content_bg text-white placeholder-placeholder p-2 rounded-lg focus:outline-none grow">
        </div>
        <div class="flex items-center justify-between">
            <div class="flex space-x-4 text-blue-400 ml-2">
                <label for="image_one" class="cursor-pointer">
                    <input type="file" id="image_one" name="image_one" class="focus:outline-none hidden ml-1">
